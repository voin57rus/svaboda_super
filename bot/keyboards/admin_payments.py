...
def payments_menu_kb(stars_enabled: bool, crypto_enabled: bool, cards_enabled: bool, qr_enabled: bool=False, monthly_reset_enabled: bool=False, demo_enabled: bool=False, wata_enabled: bool=False, platega_enabled: bool=False, cardlink_enabled: bool=False, yoomoney_enabled: bool=False) -> InlineKeyboardMarkup:
    """
    ...
    Args:
        ...
        yoomoney_enabled: Включена ли оплата через YooMoney
    """
    ...
    builder.row(InlineKeyboardButton(text=f'💰 YooMoney: {yoomoney_status}', callback_data='admin_payments_yoomoney'))
...
def yoomoney_management_kb(is_enabled: bool) -> InlineKeyboardMarkup:
    """
    Меню управления оплатой через YooMoney.

    Args:
        is_enabled: Включена ли YooMoney-оплата сейчас
    """
    builder = InlineKeyboardBuilder()
    toggle_text = 'Выключить 🔴' if is_enabled else 'Включить 🟢'
    builder.row(InlineKeyboardButton(text=toggle_text, callback_data='admin_yoomoney_mgmt_toggle'))
    builder.row(InlineKeyboardButton(text='🆔 Изменить Client ID', callback_data='admin_yoomoney_mgmt_edit_client_id'))
    builder.row(InlineKeyboardButton(text='🔐 Изменить Secret Key', callback_data='admin_yoomoney_mgmt_edit_secret_key'))
    builder.row(back_button('admin_payments'), home_button())
    return builder.as_markup()
